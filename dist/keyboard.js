...
// if true, compare key combos with string comparison, not full combo comparison
KeyCombo.fastComparison = false;
...
KeyCombo.prototype.isEqual = function(otherKeyCombo) {
  ...
  if (typeof otherKeyCombo === 'string') {
    if (KeyCombo.fastComparison) {
      return this.sourceStr === otherKeyCombo;
    }
