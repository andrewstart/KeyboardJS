...
function KeyCombo(o){this.sourceStr=o,this.subCombos=KeyCombo.parseComboStr(o),this.keyNames=this.subCombos.reduce(function(o,e){return o.concat(e)},[])}KeyCombo.sequenceDeliminator=">>",KeyCombo.comboDeliminator=">",KeyCombo.keyDeliminator="+",KeyCombo.fastComparison=!1,KeyCombo.parseComboStr=function(o){for(var e=KeyCombo._splitStr(o,KeyCombo.comboDeliminator),t=[],r=0;r<e.length;r+=1)t.push(KeyCombo._splitStr(e[r],KeyCombo.keyDeliminator));return t},KeyCombo.prototype.check=function(o){for(var e=0,t=0;t<this.subCombos.length;t+=1)if(e=this._checkSubCombo(this.subCombos[t],e,o),-1===e)return!1;return!0},KeyCombo.prototype.isEqual=function(o){if(!o||"string"!=typeof o&&"object"!=typeof o)return!1;if("string"==typeof o){if(KeyCombo.fastComparison)return this.sourceStr===o;o=new KeyCombo(o)}if(this.subCombos.length!==o.subCombos.length)return!1;for(var e=0;e<this.subCombos.length;e+=1)if(this.subCombos[e].length!==o.subCombos[e].length)return!1;for(var e=0;e<this.subCombos.length;e+=1){for(var t=this.subCombos[e],r=o.subCombos[e].slice(0),s=0;s<t.length;s+=1){var i=t[s],n=r.indexOf(i);n>-1&&r.splice(n,1)}if(0!==r.length)return!1}return!0},KeyCombo._splitStr=function(o,e){for(var t=o,r=e,s="",i=[],n=0;n<t.length;n+=1)n>0&&t[n]===r&&"\\"!==t[n-1]&&(i.push(s.trim()),s="",n+=1),s+=t[n];return s&&i.push(s.trim()),i},KeyCombo.prototype._checkSubCombo=function(o,e,t){o=o.slice(0),t=t.slice(e);for(var r=e,s=0;s<o.length;s+=1){var i=o[s];if("\\"===i[0]){var n=i.slice(1);(n===KeyCombo.comboDeliminator||n===KeyCombo.keyDeliminator)&&(i=n)}var b=t.indexOf(i);if(b>-1&&(o.splice(s,1),s-=1,b>r&&(r=b),0===o.length))return r}return-1},module.exports=KeyCombo;
